    ...
    <section className="portfolio">
        ...
        <div onClick={()=> null} id="slotify_button" className="more__button">
          ...
          <div className="more__button--box">
            ...
            <svg className="more__button--box-icon">
              <use 
                href="/static/img/icomoon/sprite.svg#icon-circle-right">
              </use>
            </svg>
          </div>
        </div>
      ...
      <div className="project">
        ...
        <div className="project__container">
          ...
          <div className="project__container--text-box">
            <p className="project__description--text">
              <span className="u-color-red">Powder</span> is a website
      ...
      <div className="project">
        ...
        <div onClick={() => null} id="casino_31_button" className="more__button">
          <div className="more__button--spacer"></div>
          <div className="more__button--box">
            <p className="more__button--box-text">Built With</p>
            <svg className="more__button--box-icon">
      ...
      <div className="project">
        ...
        <div className="project__container">
          ...
          <div className="project__container--text-box">
            <p className="project__description--text">
              <span className="u-color-red">Ultimate Fan</span> is a
        ...
        <div onClick={() => null} id="ultimate_fan_button" className="more__button">
          <div className="more__button--spacer"></div>
          <div className="more__button--box">
            <p className="more__button--box-text">Built With</p>
            <svg className="more__button--box-icon">
              <use 
                xlinkHref="/static/img/icomoon/sprite.svg#icon-circle-right">
              </use>
            </svg>
          </div>
        </div>
