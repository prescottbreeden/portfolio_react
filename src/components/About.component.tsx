      ...
      <section className="about">
        <div className="about__text-box">
          ...
          <p className="about__blurb">
            I am a full-stack software engineer that specializes in JavaScript,
            Node, and React. I am proficient with Microsoft stacks using C# and
            F#. I have experience designing SQL, noSQL, and GraphQL data
            backends. I am an open-source contributor. I am passionate about
            software design and functional programming, and from time to time, I
            like to blog about it.
          </p>
          {/* <p className="about__blurb"> */}
          {/*   There is nothing - absolutely nothing - half so much worth doing as */}
          {/*   simply messing about in code. It has the science I crave as a */}
          {/*   published researcher. It is a bottomless pit of learning */}
          ...
          {/*   it is the human factor, from the friendships of your teammates to */}
